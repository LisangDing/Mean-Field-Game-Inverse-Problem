...
n=1000000; % interation time
sigma=0.0000002; % iteration parameter for priaml step
tau=0.0000001; % iteration parameter for dual step
dx=l/M;
dt=t/N;

% accelerating parameter for tau
acpm=1000;
...
% g11, g12, g22 are the elements of the ground metric matrix
...
% save the forward problem datas.
save('forward_data_2D.mat','M','N','rho','vx','vy','cbase','l','t')